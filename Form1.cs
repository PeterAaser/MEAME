...
namespace MeaExampleNet
{
    ...
    public partial class Form1 : Form
    {
        ...
        // static ZSocket requester = new ZSocket(context, ZSocketType.REQ);
        ...
        private void CbDevicesSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            const int Samplingrate = 1000; // MC_Card does not support all settings, please see MC_Rack for valid settings
...
//            MessageBox.Show(@"Mea Device Error: " + msg);
       ...
       void OnChannelDataLater(ushort[] data, int offset)
        ...
        void DrawChannel(ushort[] data){
            ...
            //     requester.Connect("tcp://129.241.111.251:1234");

            //     for (int nn = 0; nn < 10; ++nn){
            //         string requestText = "Hai2u";
            ...
            //     string finalRequestText = "END";
            //     requester.Send(new ZFrame(finalRequestText));
